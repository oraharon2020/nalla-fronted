...
class Bellano_Settings {
    ...
    private function __construct() {
        ...
        // Initialize order attributes hooks for REST API orders (only if checkout module is loaded)
        // Bellano_Checkout::init_order_attributes_hooks(); // Disabled - Meshulam integration
    }
